...
<th scope="row">주소 <img src="${pageContext.request.contextPath}/resources/images/ico_required.gif" class="" alt="필수"></th>
 <td>
   <input style="width: 80px;" id="address" name="address" value="${member.address}" class="input_Join" placeholder="우편번호" readonly="readonly" maxlength="14" type="text">
...
$("#button").click(function() {
	...
	var email = $("#email").val();
	var ch = new Array(pw,name,phone,address,email);
	var check=0;
